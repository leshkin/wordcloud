export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      ...
      insertDemoText: 'Insert demo text',
      clear: 'Clear',
      redraw: 'Redraw',
      errors: {
    ...
    es: {
      ...
      insertDemoText: 'Insertar texto de demostración',
      clear: 'Claro',
      redraw: 'Redibujar',
      errors: {
    ...
    de: {
      ...
      insertDemoText: 'Demo-Text einfügen',
      clear: 'Klar',
      redraw: 'Neu zeichnen',
      errors: {
    ...
    fr: {
      ...
      insertDemoText: 'Insérer un texte de démonstration',
      clear: 'Clair',
      redraw: 'Redessiner',
      errors: {
    ...
    pt: {
      ...
      insertDemoText: 'Inserir texto de demonstração',
      clear: 'Claro',
      redraw: 'Redesenhar',
      errors: {
    ...
    tr: {
      ...
      insertDemoText: 'Demo metni ekle',
      clear: 'Temizlemek',
      redraw: 'Yeniden çiz',
      errors: {
    ...
    pl: {
      ...
      insertDemoText: 'Wstaw tekst demonstracyjny',
      clear: 'Jasne',
      redraw: 'Przerysować',
      errors: {
    ...
    tl: {
      ...
      insertDemoText: 'Ipasok ang demo text',
      clear: 'Maaliwalas',
    ...
    ru: {
      ...
      insertDemoText: 'Вставить демо текст',
      clear: 'Очистить',
      redraw: 'Перерисовать',
      errors: {
    ...
    uk: {
      ...
      info: 'Хмара слів — це інструмент для створення онлайн-хмари слів із вашого тексту та безкоштовного завантаження отриманого зображення.',
      placeholder: 'Вставте текст, щоб створити хмару слів',
      generate: 'Створіть хмару слів',
      insertDemoText: 'Вставити демо текст',
      clear: 'Очистити',
      redraw: 'Перемалювати',
      errors: {
    ...
    hi: {
      header: 'शब्द बादल',
      title: 'वर्ड क्लाउड - मुफ़्त ऑनलाइन टैग क्लाउड जेनरेटर',
      ...
      insertDemoText: 'डेमो टेक्स्ट डालें',
      clear: 'स्पष्ट',
    ...
    zh: {
      header: '词云',
      title: '词云 - 免费在线标签云生成器',
      info: '词云是一种根据文本在线创建词云并免费下载结果图像的工具。',
      placeholder: '插入文本以创建词云',
      generate: '生成词云',
      insertDemoText: '插入演示文本',
      clear: '清除',
      redraw: '重绘',
      errors: {
